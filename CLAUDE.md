...
Retriever is now Claude Code-first. When working in this repository, keep Claude-facing behavior and Retriever backend behavior aligned.
...
- Compatibility bundle help: `python3 skills/tool-template/tools.py --help`
