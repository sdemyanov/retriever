...
SUBCOMMAND_BLURBS: dict[str, str] = {
    ...
    "refresh-previews": "regenerate generated document and conversation preview artifacts",
...
SUBCOMMAND_USE_WHEN: dict[str, str] = {
    ...
    "refresh-previews": "you need to regenerate generated document and conversation preview artifacts using the current preview refresh alias",
