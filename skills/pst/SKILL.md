...
- For Claude Code use, run one bounded ingest command at a time with `--budget-seconds 35` and continue from `next_recommended_commands` while `more_work_remaining: true`.
