...
- Generated preview types:
  ...
  - `pst` -> email/calendar messages get one `.html` message preview; chat messages get a Slack-style document/message preview plus a Slack-style full conversation preview
